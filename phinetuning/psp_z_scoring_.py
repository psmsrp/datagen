...
total=m1_match=m2_match=m3_match=bm_match=gpt_match=0
...
# Display results
print(f"\nBase Model Alignmnet (Pred== GT, for GOOD Summaries): {(bm_match/total):.4f}, matching {bm_match} entries out of {total}")
print(f"\nFinetuned Model-1 (First Model) Alignmnet (Pred== GT, for GOOD Summaries): {(m1_match/total):.4f}, matching {m1_match} entries out of {total}")
print(f"\nFinetuned Model-2 (Early Stoppage / 10 Epochs Model) Alignmnet (Pred== GT, for GOOD Summaries): {(m2_match/total):.4f}, matching {m2_match} entries out of {total}")
print(f"\nFinetuned Model-3 (Only GOOD Examples) Alignmnet (Pred== GT, for GOOD Summaries): {(m3_match/total):.4f}, matching {m3_match} entries out of {total}")
print(f"\nGPT-4o  Alignmnet (Pred== GT, for GOOD Summaries): {(gpt_match/total):.4f}, matching {gpt_match} entries out of {total}")
